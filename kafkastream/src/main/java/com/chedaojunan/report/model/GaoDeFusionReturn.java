...
public class GaoDeFusionReturn {
    ...
    private GaoDeFusionReturn gaoDeFusionReturn;

    public GaoDeFusionReturn() {
    }

    public GaoDeFusionReturn(GaoDeFusionReturn gaoDeFusionReturn) {
        setGaoDeFusionReturn(gaoDeFusionReturn);
    }
    ...
    public GaoDeFusionReturn getGaoDeFusionReturn() {
        return gaoDeFusionReturn;
    }

    public void setGaoDeFusionReturn(GaoDeFusionReturn gaoDeFusionReturn) {
        this.gaoDeFusionReturn = gaoDeFusionReturn;
    }
