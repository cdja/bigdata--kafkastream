...
public class SampledDataCleanAndRetTest {
    ...
    public void init() throws IOException {
        ...
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211191", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211192", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211193", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211194", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211195", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
        fixedFrequencyAccessData = new FixedFrequencyAccessData("70211196", "64691168800", "001", "1521478861000", "1521478861000",
                "event_id_list", "file_id_list", 39.00, 129.01, 30.98, 98.00, 98.19, 20.3, 20.4, 20.5, 20.6, 20.7, 20.8, 20.9,
                80.01, "target_id", "target_type", 1234.01,3, 3, 18.92,
                32.32, "target_lane_info" , "source_id");
        list.add(fixedFrequencyAccessData);
