...
public class FixedFrequencyIntegrationData1 extends FixedFrequencyAccessData {
  ...
  public FixedFrequencyIntegrationData1(){}

  /*public FixedFrequencyIntegrationData1(FixedFrequencyAccessData accessData) {
  ...
  public FixedFrequencyIntegrationData1(FixedFrequencyAccessData accessData, GaoDeFusionReturn gaoDeFusionReturn) {
    this.device_id = accessData.getDevice_id();
    this.device_imei = accessData.getDevice_imei();
    this.trip_id = accessData.getTrip_id();
    this.local_time = accessData.getLocal_time();
